...
import {addUserChat} from "@/api/userChatController.ts";
  ...
  <div id="homePage">
    <div class="container">
      ...
      <div class="hero-section">
        <h1 class="hero-title">中航红外 AI智能平台</h1>
        <p class="hero-description">一句话轻松问遍天下事</p>
      </div>
...
.hero-section::before {
  ...
  right: 0;
  bottom: 0;
  background: radial-gradient(ellipse 800px 400px at center, rgba(59, 130, 246, 0.12) 0%, transparent 70%),
